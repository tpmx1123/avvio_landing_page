export default function MakeMoneySection() {
  return (
    <section className="w-full h-[100vh] bg-[#aaff00] flex items-center justify-center px-6 py-28 md:py-40">
      
      <div className="max-w-6xl text-center">
        
        {/* Heading */}
        <h2 className="text-black font-medium leading-tight tracking-tight text-4xl sm:text-5xl md:text-6xl lg:text-7xl">
