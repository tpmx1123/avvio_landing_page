...
export default function MoneySimpleSection({
  ...
  return (
    <section className="absolute inset-0 z-30 flex items-start md:items-center px-6 pt-28 md:pt-0 md:px-12">
      ...
      <div className="w-full max-w-md mx-auto md:ml-auto md:mr-0 md:max-w-3xl lg:pr-16">
        ...
        >
          <h2 className="text-[42px] md:text-7xl font-black text-black mb-6 md:mb-8 leading-[0.9] tracking-tight ">
            Money, finally <br /> simple
          </h2>

          <p className="text-[18px] md:text-3xl font-medium text-zinc-400 max-w-xl leading-snug">
