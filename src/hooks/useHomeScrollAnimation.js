...
export function useHomeScrollAnimation(containerRef) {
  ...
  const phoneY = useTransform(
    ...
    isCompact 
      ? ['30%', '20%', '12%', '6%', '2%'] // Mobile/tablet: move phone higher
  ...
  const phoneScale = useTransform(
    smooth,
    [0, 0.26, 0.5, 0.74],
    isCompact ? [0.96, 1, 0.9, 0.86] : [1.08, 1, 0.86, 0.82]
  )
  ...
  const bgGradient = useTransform(
    smooth,
    isCompact ? [0, 0.62, 0.74] : [0.14, 0.26, 0.62],
    isCompact
      ? [
  ...
  const moneyOpacity = useTransform(smooth, isCompact ? [0.66, 0.9] : [0.46, 0.68], [0, 1])
  const moneyY = useTransform(smooth, isCompact ? [0.66, 0.9] : [0.46, 0.68], isCompact ? [220, 120] : [70, 0])
  const moneyX = useTransform(smooth, isCompact ? [0.66, 0.9] : [0.46, 0.68], isCompact ? [0, 0] : [90, 0])
  const moneyScale = useTransform(smooth, isCompact ? [0.66, 0.9] : [0.46, 0.68], isCompact ? [0.98, 1] : [0.95, 1])
  const blur = useTransform(smooth, isCompact ? [0.66, 0.9] : [0.46, 0.68], isCompact ? [10, 0] : [8, 0])
